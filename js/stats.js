...
let pastEvents = [];
let arrayEvents;
let allEventsPerformance;
let bottonPerformace;
let capacityPerformance;
...
async function getEvents() {
  try {
    ...
    //sort of top events
    allEventsPerformance = filterEventsPerformance(pastEvents).sort(
      (perf1, perf2) => {
    ...
    //botton percetage
    bottonPerformace = allEventsPerformance.slice().reverse();
    ...
    //larger capacity
    capacityPerformance = allEventsPerformance.slice().sort((perf1, perf2) => {
